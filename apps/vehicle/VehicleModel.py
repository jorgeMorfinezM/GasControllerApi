...
class VehicleModel(Base):
    ...
    vehicle_manufacturer = Column(cfg_db.GasVehicle.vehiculo_fabricante, String, nullable=False, index=True)
    vehicle_model = Column(cfg_db.GasVehicle.vehiculo_modelo, String, nullable=False, index=True)
    vehicle_brand = Column(cfg_db.GasVehicle.vehiculo_marca, String, nullable=False, index=True)
    vehicle_plate = Column(cfg_db.GasVehicle.vehiculo_matricula, String, nullable=False, index=True)
    ...
    vehicle_anio_model = Column(cfg_db.GasVehicle.vehiculo_anio_modelo, Integer, nullable=True, index=True)
    ...
    vehicle_transmision = Column(cfg_db.GasVehicle.vehiculo_transmision, String, nullable=True, index=True)
    vehicle_gas_type = Column(cfg_db.GasVehicle.vehiculo_tipo_combustible, String, nullable=False, index=True)
    ...
    vehicle_register_date = Column(cfg_db.GasVehicle.vehiculo_fecha_registro, Date, nullable=True, index=True)
    vehicle_low_register_date = Column(cfg_db.GasVehicle.vehiculo_fecha_baja, Date, nullable=False)

    def __init__(self, data_vehicle):

        self.vehicle_manufacturer = data_vehicle.get('vehiculo_fabricante')
